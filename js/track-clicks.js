  ...
  if (event.target.tagName === 'A') {
      ...
      if (event.target.onclick) {
        ...
        const match = onclickString.match(/scrollIntoView\({behavior: 'smooth'}\)\'/);
          ...
          }else if (event.target.onclick.toString().includes("window.location.href='https://pay.kirvano.com/98dd6353-1008-4a83-bb81-aad80ac1fe06'")) {
            destino = "https://pay.kirvano.com/98dd6353-1008-4a83-bb81-aad80ac1fe06";
            tipo_click = "botao_checkout"
           } else {
            destino = "NA";
            tipo_click = "botao_sem_destino";
          }
